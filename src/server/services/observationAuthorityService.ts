...
export const OBSERVATION_SAGA_SHARED_CONTRACTS = Object.freeze({
  ...
  semanticActionProgram: 'gma.semantic-action-program/4', semanticActionCompilerPolicy: 'gma.semantic-action-compiler-policy/10',
  ...
  observationPreparationPacket: 'gma.observation-authority-preparation-packet/4',
  observationPreparationCandidate: 'gma.observation-authority-preparation-candidate/3',
