...
Return exactly one JSON object matching responseContract. For narration return {narration,interactionResolution,npcDialogue,requiresVcsResolution,proposedCanonChanges,proposedVcsExports,proposedTimeAdvance,sceneSegmentUpdate,riskLevel,syncNotes,gmPrivateNotes}.`;
