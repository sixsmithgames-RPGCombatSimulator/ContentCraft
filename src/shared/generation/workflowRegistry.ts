...
const STAGE_DEFINITIONS: Record<string, StageDefinition> = {
  ...
  character_build_feature_inventory: {
    ...
    label: 'Creator: Character Build Inventory',
    aliases: ['character_build_feature_inventory', 'characterBuildFeatureInventory', 'Creator: Character Build Inventory'],
    contentTypes: ['npc'],
    manualModeSupported: true,
    retrievalPolicy: 'hints_allowed',
    retryPolicy: DEFAULT_RETRY_POLICY,
  ...
  character_build_feature_enrichment: {
    ...
    label: 'Creator: Character Build Enrichment',
    aliases: ['character_build_feature_enrichment', 'characterBuildFeatureEnrichment', 'Creator: Character Build Enrichment'],
    contentTypes: ['npc'],
    manualModeSupported: true,
    retrievalPolicy: 'hints_allowed',
    retryPolicy: DEFAULT_RETRY_POLICY,
