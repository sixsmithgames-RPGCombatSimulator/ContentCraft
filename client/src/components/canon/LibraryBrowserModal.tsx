...
export default function LibraryBrowserModal({
  ...
  const handleSaveEntity = async (updatedEntity: CanonBase) => {
    ...
    try {
      const response = await apiFetch(`${API_BASE_URL}/canon/entities/${payload._id}`, {
        method: 'PUT',
        headers: { 'Content-Type': 'application/json' },
  ...
  const handleDeleteEntity = async () => {
    ...
    try {
      const response = await apiFetch(`${API_BASE_URL}/canon/entities/${entityToEdit._id}`, {
        method: 'DELETE',
      });
    ...
    try {
      ...
      for (const entity of entitiesToUpdate) {
        try {
          ...
          const response = await apiFetch(`${API_BASE_URL}/canon/entities/${entity._id}`, {
            method: 'PUT',
            headers: { 'Content-Type': 'application/json' },
            body: JSON.stringify({
              ...entity,
